...
file_path = "/home/samaudensiel/Desktop/Aziz/TutriceFolder/KITTI-distance-estimation-master/distance-estimator/data/test.csv"

def main():
    # get data
    # print("ecrire le chemin du fichier de test")
    # chemin = input()
